...
const CardsProducts = ({ categorie, sous_categorie }) => {
    const { data, isLoading } = useGetProductsQuery({ categorie: categorie, sous_categorie: sous_categorie, quantity: 10, skip: 0, q: null, f: null })
